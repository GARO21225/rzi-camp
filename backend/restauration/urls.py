...
from .views import MenuJourViewSet, QRTokenViewSet, RepasLogViewSet, AuditLogViewSet, ArticleBoutiqueViewSet, ConsommationBoutiqueViewSet, BonCaisseViewSet, AvisRestaurationViewSet
