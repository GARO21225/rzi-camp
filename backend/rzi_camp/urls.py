...
def backup_status(request):
    ...
    SÉCURITÉ : réservé aux utilisateurs connectés — les comptes de lignes
    (personnel, incidents...) sont une information utile à un attaquant
    en reconnaissance, donc jamais exposés sans authentification."""
    import os
    from django.db import connection
...
urlpatterns = [
    ...
    # Endpoint de debug supprimé (test-boutique) : exposait le schéma de la
    # base sans authentification et pouvait insérer de fausses ventes.
