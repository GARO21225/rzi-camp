...
const CHAMPS = [
  ...
  { section: '📱 Connexion par SMS (OTP)', items: [
    ...
    { cle: 'sms_hsms_token', label: 'HSMS — Token API', suffix: '', type: 'password', hint: 'Obtenu via POST /api/token/ (email + mot de passe) ou copié depuis votre tableau de bord hsms.ci — documentation confirmée' },
