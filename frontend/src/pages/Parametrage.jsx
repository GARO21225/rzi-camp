...
const CHAMPS = [
  ...
  { section: '📱 Connexion par SMS (OTP)', items: [
    { cle: 'sms_provider', label: 'Fournisseur SMS', suffix: '', type: 'text',
      hint: 'test (aucun envoi réel — code visible à l\'écran, pour valider le flux gratuitement), orange, africastalking, prosms (bientôt disponible), hsms (bientôt disponible), twilio (en cours de retrait)' },
    { cle: 'canal_otp', label: "Canal d'envoi du code OTP", suffix: '', type: 'text',
      hint: 'sms ou whatsapp — whatsapp nécessite le fournisseur twilio avec un numéro approuvé WhatsApp Business, ou whatsapp_provider=meta ci-dessous' },
    { cle: 'sms_prosms_api_key', label: 'proSMS — Clé API', suffix: '', type: 'password', hint: 'Fournisseur en cours d\'intégration — confirmation du service exact en attente' },
    { cle: 'sms_prosms_sender_id', label: 'proSMS — Nom expéditeur', suffix: '', type: 'text', hint: '' },
    { cle: 'sms_hsms_api_key', label: 'HSMS — Clé API', suffix: '', type: 'password', hint: 'hsms.ci — fournisseur en cours d\'intégration' },
    { cle: 'sms_hsms_sender_id', label: 'HSMS — Nom expéditeur', suffix: '', type: 'text', hint: '' },
    { cle: 'sms_twilio_account_sid', label: 'Twilio — Account SID (en cours de retrait)', suffix: '', type: 'text', hint: 'Depuis console.twilio.com' },
    { cle: 'sms_twilio_auth_token', label: 'Twilio — Auth Token (en cours de retrait)', suffix: '', type: 'password', hint: 'Depuis console.twilio.com' },
    { cle: 'sms_twilio_from', label: 'Twilio — Numéro expéditeur (en cours de retrait)', suffix: '', type: 'text', hint: 'Ex: +14155238886' },
