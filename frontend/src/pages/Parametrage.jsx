...
const CHAMPS = [
  ...
  { section: '📱 Connexion par SMS (OTP)', items: [
    { cle: 'sms_provider', label: 'Fournisseur SMS', suffix: '', type: 'text',
      hint: 'test (aucun envoi réel — code visible à l\'écran, pour valider le flux gratuitement), orange, africastalking, prosms, hsms (bientôt disponible), twilio (en cours de retrait)' },
